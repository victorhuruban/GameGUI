...
public class GameInitialization implements Serializable {
    ...
    public GameInitialization(int num) {
        ...
        if (num == 1) {
            ...
            cb.getLocation(0, 4).setPiece(new King(0, 4, "white"));
            cb.getLocation(0, 3).setPiece(new Queen(0, 3, "white"));
            ...
            cb.getLocation(7, 4).setPiece(new King(7, 4, "black"));
            cb.getLocation(7, 3).setPiece(new Queen(7, 3, "black"));
